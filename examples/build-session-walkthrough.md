...
- BUILD_BRIEF: none
- STATE_FILE: .kit/session-state/2026-05-02--104500/state.json
...
- Captures stdout+stderr to `.kit/session-state/<id>/test-captures/iter-001.log`
...
✅ Private handoff written: .kit/session-state/2026-05-02--104500/handoffs.md
...
```
.kit/session-state/2026-05-02--104500/
...
~/.agents/session-state/INDEX.md          # device-wide cross-repo index row
