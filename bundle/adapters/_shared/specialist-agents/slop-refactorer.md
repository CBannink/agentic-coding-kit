...
description: Detect and fix AI-generated code slop after implementation. Runs detect-slop.ps1 then applies judgment-level fixes (comment cleanup, naming, extraction). Must NOT change behavior.
