---
name: goal-reviewer
description: Independently verify whether a stated goal was actually achieved by reading code changes against original success criteria. Unlike final-verifier (tests pass), this checks semantic goal achievement. Use between convergence and handoff.
