...
2. Do not preload .kit, .wiki, handoffs, history, or memory files.
3. Use .wiki/index.md only as an on-demand index when architecture, feature, or principle context is needed.
4. Self-improvement tools are manual maintenance only.
