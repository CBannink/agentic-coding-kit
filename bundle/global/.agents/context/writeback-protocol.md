...
|---|---|---|
| `REPO-FACT` | `.codex/context/memory.md` | Durable repo architecture, verified commands, schema decisions, constraints |
| `REPO-SPECIALIST` | `.codex/context/agent-memory/shared.md` or `.codex/context/agent-memory/{role}.md` | Durable repo-local guidance that is only useful to one specialist role or a small set of specialist roles |
...
3. it is not general enough for `.codex/context/memory.md`
...
- general repo architecture facts → `.codex/context/memory.md`
