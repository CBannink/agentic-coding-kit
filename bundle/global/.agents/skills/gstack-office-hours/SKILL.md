...
> The baked-in questions below are complete and self-contained — follow them directly.
>
> The raw vendored plugin at `~/.agents/workflows/plugins/gstack/office-hours/SKILL.md`
...
- `~/.agents/workflows/plugins/gstack/office-hours/SKILL.md` (raw vendored; contains unresolved template sections — ignore any runtime/operational blocks)
