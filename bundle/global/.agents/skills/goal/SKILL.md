---
name: goal
description: "Use for autonomous multi-step goals. Owns loop state and convergence until success criteria are met or blocked."
---

# /goal

The current session owns goal convergence. Do not spawn another goal
orchestrator.
