...
> The baked-in pass structure below is complete and self-contained — follow it directly.
>
> The raw vendored plugin at `~/.agents/workflows/plugins/gstack/qa/SKILL.md`
...
- `~/.agents/workflows/plugins/gstack/qa/SKILL.md` (raw vendored; contains unresolved template sections — ignore any runtime/operational blocks)
