...
| Global plugin layer | `~/.agents/workflows/` | gstack / superpowers / extended prompts |
| Repo-local context | `.kit/context/` | durable repo memory, history, handoffs, reflections |
