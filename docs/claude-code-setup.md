...
This kit was built in a Copilot CLI environment, but it can be used in **Claude Code** if you keep the core operating model intact.
...
| Concept | Keep it? |
|---|---|
| `.codex/context/*` repo memory model | **Yes** |
...
2. bootstrap `.codex` and `.wiki` into a target repo
