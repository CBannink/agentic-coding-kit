---
name: threat-model
description: Threat-model a feature, component, system, or current change by mapping assets, actors, data flows, trust boundaries, existing controls, and concrete attack paths. Use focused, full, or incremental analysis and independently challenge material findings without changing implementation.
---
