---
name: review
description: Independently review a working tree, commit range, branch, contract and implementation, design, test-only delta, subsystem, or migration plan using evidence-backed findings and dynamically selected correctness, architecture, testing, failure, compatibility, migration, performance, or security lenses.
---

<!-- @generated by Agentic Coding Kit v6; source=core/skills/review/SKILL.md; sourceId=skill:review:SKILL.md -->
