---
name: grill
description: Resolve consequential product or engineering ambiguity through a focused one-question-at-a-time interview. Use only when the user explicitly asks to be grilled, interviewed, challenged, or helped to sharpen a specification.
---

<!-- @generated by Agentic Coding Kit v6; source=core/skills/grill/SKILL.md; sourceId=skill:grill:SKILL.md -->
