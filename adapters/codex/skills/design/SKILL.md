---
name: design
description: Produce or review a feature, architecture, or UI design before implementation, using current repository evidence, material options, an explicit Design Contract, independent review, and optional Sage challenge; transition into build in the same main session when implementation is requested.
---
